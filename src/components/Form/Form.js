...
const Form = ({
    ...
    const [title, setTitle] = React.useState(eventItem ? title : null);
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
        const updatedEvent = {
            id: eventItem ? eventItem.id : null,
            title,
            date,
            startTime,
            endTime,
    ...
    return ( <
            ...
            FormTitle > { eventItem == null ? "New Event" : "Edit Event" } <
            /FormTitle> <
            ...
            div >
            <
            InputLabel > Start and End: < /InputLabel> <
            br / >
            <
            TimeInput type = "time"
            name = "start-time"
